...
class _TodoState extends State<Todo> {
  ...
  Future<bool> StoreData(String date) async {
    print("items len: ${item.length}");
    List<String> data = [];
    for (int i = 0; i < item.length; i++) {
    ...
    var STodod = StoreTask(dateTime: date, alltask: d, score: calScore());
    print("$_date res: $STodod");
        ...
        appBar: AppBar(
          ...
          actions: [
            IconButton(
              ...
              onPressed: () {
                print("del $formatted : ${db.deleteTodo(formatted)}");
                item.clear();
